    ...
    <div class="p-4">
        <div class="p-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="bankTransfer bg-white p-4 rounded-md w-full hover:shadow-xl cursor-pointer">
                ...
                <p>BANK: UNITY BANK</p>
                <p>ACCOUNT NAME: IK MOORE UNITED COMPANY NIGERIA LIMITED.</p>
                <p>ACCOUNT NUMBER: 0028363372</p>
            </div>
            <div class="bankTransfer bg-white p-4 rounded-md w-full hover:shadow-xl cursor-pointer">
                ...
                <p class="pb-3 select-all">1Br6XZA3uJxsvWCA2BsbbcfgURrcBtDTNP</p>
            </div>
        </div>
        <p class="px-8">
            After making payment, send a screenshot via Whatsapp to contact number:
            <a class="text-brand-blue font-semibold" href="tel:+2348120912268">2348120912268</a>. An account will immediately be created for you and you will be added to all eligible training channels. All login details will be sent to you.
        </p>
    </div>
</template>
